...
```
Excel и подобные программы могут сохранять табличные данные в CSV файлы. Поэтому такой формат можно использовать в качестве промежуточного, чтобы перевести данные из файла таблиц в БД.


**Особенности работы SQLite**
